    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-1 max-w-3xl text-sm leading-6 text-muted">
          Quill works best when it understands how you naturally write. Use your past LinkedIn
          posts if you have them, paste writing you already trust, or start from a clean
          foundation if you are still defining your voice. Once this is set, Compose can generate
          from ideas, rewrite rough notes, and improve drafts in your voice.
        </p>
      </div>
              ...
              {importOpen && (
                <div className="mt-4 space-y-3">
                  <p className="text-sm leading-6 text-muted">
                    Download your LinkedIn data export from LinkedIn Settings → Data Privacy → Get
                    a copy of your data → Posts. Then upload the Posts.csv file here.
                  </p>
                  <input
                    type="file"
                    accept=".csv,text/csv"
        ...
        <div className="quill-card p-6">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">
              This is a starting point for people who do not have enough past content yet. Pick the
              closest foundation now, then let Quill adapt it over time as you write more.
            </p>
          </div>
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-6 text-muted">{foundation.description}</p>
                  </div>
                  {selectedFoundation === foundation.key && (
          ...
          {selectedFoundationData && (
            <div className="mt-5 rounded-xl border border-line bg-slate-50 p-4 text-sm leading-6 text-muted">
              ...
              <p className="mt-2">
                This is a temporary starting foundation, not a final identity. Quill can adapt it
                as it learns from your real writing.
              </p>
            </div>
          )}
        </div>
        ...
        {loading ? (
          ...
          <>
            <Button
              ...
              onClick={() => void analyzeFromSamples(setupPath as "linkedin_posts" | "pasted_samples")}
        ...
        <div className="quill-card overflow-hidden">
          ...
          <div className="space-y-5 p-6">
            ...
            <div className="space-y-2">
              ...
              {profileStrength && (
                <p className="text-sm leading-6 text-muted">{profileStrength.note}</p>
              )}
            </div>
            ...
            <div className="grid gap-3 text-sm sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-line p-4">
                ...
                <p className="mt-1 font-medium text-ink">
                  {profileDimensions?.emojiUsage ?? "Not set"}
                </p>
              </div>
              <div className="rounded-lg border border-line p-4">
            ...
            <button
              ...
              className="text-sm font-medium text-brand hover:underline"
            >
              Refine this profile with new inputs
            </button>
          </div>
        </div>
      )}
