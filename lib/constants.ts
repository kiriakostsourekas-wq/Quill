...
export const ONBOARDING_COOKIE_NAME = "quill_onboarding";
export const ROLE_COOKIE_NAME = "quill_role";
export const LINKEDIN_OAUTH_COOKIE_NAME = "quill_linkedin_oauth";
export const TWITTER_OAUTH_COOKIE_NAME = "quill_twitter_oauth";
export const TWITTER_PKCE_VERIFIER_COOKIE_NAME = "twitter_pkce_verifier";
